...
class _HomePageState extends State<HomePage>
  ...
  final List<Map<String, dynamic>> _categorias = [
    {'emoji': '🥦', 'nombre': 'Verduras', 'query': 'verduras', 'color': const Color(0xFFE8F5E9), 'colorIcon': const Color(0xFF388E3C)},
    {'emoji': '🥛', 'nombre': 'Lácteos', 'query': 'leche', 'color': const Color(0xFFE3F2FD), 'colorIcon': const Color(0xFF1976D2)},
    {'emoji': '🍗', 'nombre': 'Carnes', 'query': 'pollo', 'color': const Color(0xFFFCE4EC), 'colorIcon': const Color(0xFFC62828)},
    {'emoji': '🍞', 'nombre': 'Panadería', 'query': 'pan', 'color': const Color(0xFFFFF8E1), 'colorIcon': const Color(0xFFF9A825)},
    {'emoji': '🧴', 'nombre': 'Aseo', 'query': 'jabón', 'color': const Color(0xFFE8EAF6), 'colorIcon': const Color(0xFF3949AB)},
    {'emoji': '🥤', 'nombre': 'Bebidas', 'query': 'jugo', 'color': const Color(0xFFF3E5F5), 'colorIcon': const Color(0xFF7B1FA2)},
    {'emoji': '🍚', 'nombre': 'Granos', 'query': 'arroz', 'color': const Color(0xFFFFF3E0), 'colorIcon': const Color(0xFFE65100)},
    {'emoji': '🍳', 'nombre': 'Aceites', 'query': 'aceite', 'color': const Color(0xFFE0F7FA), 'colorIcon': const Color(0xFF00838F)},
  ];

  final List<Map<String, dynamic>> _ofertas = [
    {'emoji': '🛒', 'titulo': 'Compara granos', 'subtitulo': 'Arroz, lentejas, frijoles', 'color': const Color(0xFF1D9E75), 'query': 'arroz'},
    {'emoji': '🥛', 'titulo': 'Lácteos del día', 'subtitulo': 'Leche, queso, yogur', 'color': const Color(0xFF1976D2), 'query': 'leche'},
    {'emoji': '🍗', 'titulo': 'Proteínas', 'subtitulo': 'Pollo, carne, huevos', 'color': const Color(0xFFC62828), 'query': 'pollo'},
  ];
  ...
  Future<void> _cargarUsuario() async {
    ...
    if (!vigente) { _redirigirLogin(); return; }

    final id = await ApiService.obtenerUserId();
    if (id == null) { _redirigirLogin(); return; }
    ...
    if (mounted) {
      setState(() {
        ...
        _favoritos = List<Map<String, dynamic>>.from(
          (raw as List).map((e) => e is Map<String, dynamic> ? e : {'nombre': e.toString()}),
        );
        _cargando = false;
      });
      _animController.forward();
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: (oferta['color'] as Color).withOpacity(0.3),
                                  blurRadius: 10,
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(16),
                              border: Border.all(
                                color: (cat['colorIcon'] as Color).withOpacity(0.15),
                                width: 1,
                              ),
                            ),
                            child: Column(
                        ...
                        Row(
                          children: [
                            const Icon(Icons.favorite_rounded,
                                color: Color(0xFFD4537E), size: 18),
                            const SizedBox(width: 6),
                    ...
                    : SliverList(
                        delegate: SliverChildBuilderDelegate(
                          (context, index) {
                            ...
                            final nombre = fav['nombre']?.toString() ?? 'Producto';
                                      ...
                                      child: const Row(
                                        ...
                                        children: [
                                          Icon(Icons.compare_arrows_rounded,
                                              color: Color(0xFF0F6E56), size: 13),
                                          SizedBox(width: 4),
                                          Text('Comparar',
                                              style: TextStyle(
